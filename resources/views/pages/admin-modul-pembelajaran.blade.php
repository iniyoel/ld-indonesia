  ...
  <div class="main-col">
    ...
    <main class="page-content" id="mainContent">
      ...
      <div class="filter-bar">
        ...
        <a class="btn-add" href="admin-modul-form.html">
      ...
      tr.innerHTML =
        ...
        '<td>' +
          '<div class="action-group">' +
            '<a class="action-btn" href="admin-modul-detail.html?id=' + m.id + '" aria-label="Lihat ' + m.judul + '">' +
            ...
            '</a>' +
            '<a class="action-btn" href="admin-modul-form.html?id=' + m.id + '" aria-label="Ubah ' + m.judul + '">' +
