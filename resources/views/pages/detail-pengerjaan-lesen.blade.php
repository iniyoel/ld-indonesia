...
<title>Detail Pengerjaan — Simulasi Lesen — LD Indonesia</title>
<meta name="description" content="Detail hasil pengerjaan simulasi Lesen siswa — LD Indonesia.">
...
.passage-panel{ background:var(--white); border:1px solid var(--gray-100); border-radius:var(--radius-md); padding:24px 26px; position:sticky; top:calc(var(--topbar-h) + 24px); }
...
.quiz-card{ background:var(--white); border:1px solid var(--gray-100); border-radius:var(--radius-md); padding:26px 28px; display:flex; flex-direction:column; min-height:420px; }
.quiz-progress{ color:var(--pink-dark); font-weight:800; font-size:0.95rem; margin-bottom:18px; }
.quiz-question{ font-size:1.08rem; color:var(--gray-800); font-weight:500; margin-bottom:22px; }
...
.explanation-box{ background:var(--pink-pale); border:1px solid var(--pink-light); border-radius:var(--radius-sm); padding:16px 20px; display:flex; gap:12px; }
...
.quiz-sidebar{ background:var(--white); border:1px solid var(--gray-100); border-radius:var(--radius-md); padding:24px; position:sticky; top:calc(var(--topbar-h) + 24px); }
    ...
    <main class="page-content" id="mainContent">
      ...
      <section class="result-panel" aria-labelledby="resultTitle">
        <div class="result-head">
          <h1 id="resultTitle">Adjektiv</h1>
          <span class="score-chip" id="scoreChip">Nilai: 100</span>
        </div>
        <p class="result-desc">Lihat teks bacaan, jawabanmu, jawaban yang benar, beserta penjelasannya untuk tiap soal.</p>
...
(function(){
  ...
  /* ==================================================================
     ...
     - Teks bacaan dan QUESTIONS di bawah masih data contoh statis.
       Saat backend siap, ganti dengan fetch('/api/riwayat/{attemptId}')
       yang memuat teks, soal, jawaban siswa, dan penjelasan sesungguhnya.
  ================================================================== */
  var QUESTIONS = [
    { text: 'Wo wohnt Anna?', options: ['In München', 'In Hamburg', 'In Berlin', 'In Köln'], correct: 1, selected: 1,
      explanation: 'Pada kalimat pertama teks disebutkan "Anna wohnt in Hamburg", jadi jawaban yang tepat adalah "In Hamburg".' },
    { text: 'Als was arbeitet Anna?', options: ['Lehrerin', 'Krankenschwester', 'Verkäuferin', 'Ingenieurin'], correct: 1, selected: 1,
      explanation: 'Teks menyebutkan Anna "arbeitet als Krankenschwester", artinya ia bekerja sebagai perawat.' },
    { text: 'Wie fährt Anna zur Arbeit?', options: ['Mit dem Auto', 'Mit dem Bus', 'Mit dem Fahrrad', 'Zu Fuß'], correct: 2, selected: 2,
      explanation: 'Disebutkan "fährt mit dem Fahrrad zur Arbeit", yaitu Anna pergi kerja dengan sepeda.' },
    { text: 'Um wie viel Uhr steht Anna auf?', options: ['Um fünf Uhr', 'Um sechs Uhr', 'Um sieben Uhr', 'Um acht Uhr'], correct: 1, selected: 1,
      explanation: 'Teks menyebutkan "steht sie um sechs Uhr auf", jadi Anna bangun pukul enam.' },
    { text: 'Was macht Anna oft nach der Arbeit?', options: ['Sie schläft', 'Sie kocht', 'Sie geht einkaufen', 'Sie liest'], correct: 2, selected: 2,
      explanation: 'Disebutkan "geht Anna oft einkaufen", artinya ia sering pergi berbelanja.' },
    { text: 'Wen trifft Anna manchmal im Café?', options: ['Ihre Kollegen', 'Ihre Freunde', 'Ihre Eltern', 'Ihren Chef'], correct: 1, selected: 1,
      explanation: 'Teks menyebutkan ia "trifft sich mit Freunden im Café", yaitu bertemu teman-temannya.' },
    { text: 'Wo wohnen Annas Eltern?', options: ['In der Stadt', 'Auf dem Land', 'Am Meer', 'Im Ausland'], correct: 1, selected: 1,
      explanation: 'Disebutkan orang tuanya "auf dem Land wohnen", artinya tinggal di pedesaan.' },
    { text: 'Wann besucht Anna ihre Eltern?', options: ['Jeden Tag', 'Am Wochenende', 'Einmal im Monat', 'Im Sommer'], correct: 1, selected: 1,
      explanation: 'Teks menyebutkan "Am Wochenende besucht sie ihre Eltern", yaitu di akhir pekan.' },
    { text: 'Was genießt Anna bei ihren Eltern?', options: ['Frische Luft', 'Gutes Essen', 'Ruhe', 'Musik'], correct: 0, selected: 0,
      explanation: 'Disebutkan ia menikmati "frische Luft zu genießen", yaitu udara segar.' },
    { text: 'Welche Sprache lernt Anna?', options: ['Englisch', 'Französisch', 'Spanisch', 'Italienisch'], correct: 2, selected: 2,
      explanation: 'Teks menyebutkan "lernt auch seit einem Jahr Spanisch", jadi bahasa yang dipelajari adalah bahasa Spanyol.' },
    { text: 'Seit wann lernt Anna diese Sprache?', options: ['Seit einem Monat', 'Seit einem Jahr', 'Seit zwei Jahren', 'Seit einer Woche'], correct: 1, selected: 1,
      explanation: 'Disebutkan "seit einem Jahr", artinya sudah belajar selama satu tahun.' },
    { text: 'Warum lernt Anna diese Sprache?', options: ['Für die Arbeit', 'Für die Reise', 'Für die Schule', 'Für die Familie'], correct: 1, selected: 1,
      explanation: 'Teks menyebutkan ia belajar karena "nächstes Jahr nach Spanien reisen möchte", yaitu untuk keperluan perjalanan.' },
    { text: 'Wie oft übt Anna die Sprache?', options: ['Jeden Morgen', 'Jeden Abend', 'Am Wochenende', 'Zweimal pro Woche'], correct: 1, selected: 1,
      explanation: 'Disebutkan "übt jeden Abend", artinya ia berlatih setiap malam.' },
    { text: 'Wie lange übt Anna jeden Tag?', options: ['15 Minuten', 'Eine Stunde', 'Eine halbe Stunde', 'Zwei Stunden'], correct: 2, selected: 2,
      explanation: 'Teks menyebutkan "eine halbe Stunde", artinya ia berlatih selama setengah jam.' },
    { text: 'Womit übt Anna die Sprache?', options: ['Mit einem Buch', 'Mit einer App', 'Mit einem Lehrer', 'Mit einem Freund'], correct: 1, selected: 1,
      explanation: 'Disebutkan ia berlatih "mit einer App", artinya menggunakan aplikasi.' }
  ];
  var LETTERS = ['A', 'B', 'C', 'D'];
  ...
  function renderQuestion(){
    ...
    q.options.forEach(function(optText, i){
      ...
      var tag = isCorrect ? '<span class="quiz-option-tag">Jawaban Benar</span>' : (isWrongSelected ? '<span class="quiz-option-tag">Jawabanmu</span>' : '');
      row.innerHTML = '<span class="quiz-option-letter">' + LETTERS[i] + '</span><span class="quiz-option-text">' + optText + '</span>' + tag;
  ...
  function renderGrid(){
    ...
    QUESTIONS.forEach(function(q, i){
      ...
      btn.addEventListener('click', function(){ state.current = i; renderQuestion(); renderGrid(); });
      soalGrid.appendChild(btn);
    });
  }

  prevBtn.addEventListener('click', function(){ if (state.current > 0){ state.current--; renderQuestion(); renderGrid(); } });
  nextBtn.addEventListener('click', function(){
    var isLast = state.current === QUESTIONS.length - 1;
    if (isLast){ window.location.href = 'performa-siswa.html'; }
    else { state.current++; renderQuestion(); renderGrid(); }
  });
