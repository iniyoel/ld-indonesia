...
<title>Dashboard Tutor — LD Indonesia</title>
<meta name="description" content="Dashboard tutor LD Indonesia: ringkasan siswa, modul, penilaian, dan performa siswa.">
...
<div class="app-shell">
  ...
  <aside class="sidebar" id="sidebar" aria-label="Navigasi utama">
    ...
    <nav class="sidebar-nav">
      <ul>
        <li>
          <a href="dashboard-tutor.html" class="nav-link active" aria-current="page">
    ...
    <main class="page-content" id="mainContent">
      ...
      <div class="dash-grid">
        <section class="panel" aria-labelledby="moduleSummaryTitle">
          ...
          <a href="tutor-modul-pembelajaran.html" class="panel-link">
            Lihat semua modul
...
(function(){
  ...
  /* ==================================================================
     ...
     - Halaman ini adalah dashboard-tutor.html: isinya sengaja dibuat
       SAMA PERSIS dengan dashboard-admin.html, hanya sidebar yang
       dibatasi (Dashboard, Modul Pembelajaran, Performa Siswa saja —
       tanpa menu "Pengguna"), sesuai ketentuan. Tautan "Modul
       Pembelajaran" dan "Performa Siswa" di sidebar mengarah ke
       tutor-modul-pembelajaran.html dan tutor-performa-siswa.html —
       salinan halaman admin dengan fungsi & isi yang identik, hanya
       sidebar dan identitas penggunanya yang disesuaikan untuk tutor.
  ================================================================== */
