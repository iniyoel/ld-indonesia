    ...
    <div class="sidebar-inner">
        ...
        <nav class="sidebar-nav">
            <ul class="nav-list">
                ...
                <li class="nav-item">
                    <a href="{{ url('/modul') }}" class="nav-link {{ request()->is('modul*') || request()->is('tutor-modul*') ? 'active' : '' }}">
                        <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li class="nav-item">
                    <a href="{{ url('/tutor-performa-siswa') }}" class="nav-link {{ request()->is('tutor-performa*') || request()->is('tutor-siswa*') ? 'active' : '' }}">
                        <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
