    ...
    <div class="sidebar-inner">
        ...
        <nav class="sidebar-nav">
            <ul class="nav-list">
                ...
                <!-- Modul Pembelajaran -->
                <li class="nav-item">
                    <a href="{{ url('/modul') }}" class="nav-link {{ request()->is('modul*') || request()->is('admin-modul*') ? 'active' : '' }}">
                        <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Performa Siswa -->
                <li class="nav-item">
                    <a href="{{ url('/admin/performa-siswa') }}" class="nav-link {{ request()->is('admin/performa-siswa*') || request()->is('admin-performa*') ? 'active' : '' }}">
                        <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
